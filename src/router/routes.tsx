...
const Clients = lazy(() => import('../pages/Apps/Clients'));
const Valets = lazy(() => import('../pages/Apps/Valets'));
const Vehicules = lazy(() => import('../pages/Apps/Vehicules'));
const Services = lazy(() => import('../pages/Apps/Services'));
const Operations = lazy(() => import('../pages/Apps/Operations'));
const Endroits = lazy(() => import('../pages/Apps/Endroits'));
const Hotspots = lazy(() => import('../pages/Apps/Hotspots'));
const Partenaires = lazy(() => import('../pages/Apps/Invoice/Partenaires'));
...
const Responsables = lazy(() => import('../pages/Components/Responsables'));
...
const Paiements = lazy(() => import('../pages/Elements/Paiements'));
...
const Géocolisation = lazy(() => import('../pages/Géocolisation'));
const Administrateurs = lazy(() => import('../pages/Administrateurs'));
